...
import { ExternalLink, Github, Code, Globe, Search } from 'lucide-react';

const Projects = () => {
  const projects = [
    {
      title: "CampusCrack",
      description: "A comprehensive platform designed to help students crack campus interviews with practice questions, mock tests, and career guidance.",
      tech: ["React", "Node.js", "MongoDB", "Express"],
      category: "Web Application",
      icon: <Code className="w-6 h-6" />,
      highlights: ["Interactive coding challenges", "Progress tracking", "Community features"]
    },
    {
      title: "Algo Google",
      description: "An algorithm visualization tool that helps students understand complex data structures and algorithms through interactive visual representations.",
      tech: ["JavaScript", "D3.js", "HTML5", "CSS3"],
      category: "Educational Tool",
      icon: <Search className="w-6 h-6" />,
      highlights: ["Real-time visualization", "Step-by-step execution", "Multiple algorithms support"]
    },
    {
      title: "Portfolio Website",
      description: "A modern, responsive portfolio website showcasing my projects, skills, and professional journey with clean design and smooth user experience.",
